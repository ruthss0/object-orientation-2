...
//Code Here
function ingredients(dessert){
  const {carb, fat, protein} = dessert;
  const values =[]
...
let cat1 = new Cat('Arquimedes', 2, 'blue');
...
const wizard = new Wizard('Harry', 15,'dig dig joy')
console.log(wizard.name)
console.log(wizard.age)
console.log(wizard.favoriteSpell)
...
/*
    ...
    sell should be a function that 
    
    changes the value of sold to true and prints the string: '{brand} {model} has been sold.'
...
const phone = new Phone('apple', 'Iphone', 64,'blue', 500)
console.log(phone.sold)
phone.sell()
 console.log(phone.sold)

console.log(phone.price)
phone.changePrice(250)
console.log(phone.price)
...
//Code Here
const phone2 = new Phone('Motorola', 'MotoG', 7, 'pink', 200)
const phone3 = new Phone('BrazilPhone', 'PauloF', 8,'Brown', 300)
const phone4 = new Phone('Samsung','SanG', 9, 'Yellow', 600)
